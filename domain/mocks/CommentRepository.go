...
func (_m *CommentRepository) Delete(_a0 context.Context, _a1 uint) error {
...
func (_m *CommentRepository) Fetch(_a0 context.Context, _a1 *[]domain.Comment, _a2 uint) error {
...
func (_m *CommentRepository) GetByUserID(_a0 context.Context, _a1 *domain.Comment, _a2 uint) error {
	ret := _m.Called(_a0, _a1, _a2)
...
func (_m *CommentRepository) Update(_a0 context.Context, _a1 domain.Comment, _a2 uint) (domain.Comment, error) {
	ret := _m.Called(_a0, _a1, _a2)
